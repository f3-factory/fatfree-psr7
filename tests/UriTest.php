...
class UriTest extends TestCase
{
    ...
    {
        $uri = new Uri($input);
        $this->assertSame($path, $uri->getPath(),'path');
        $this->assertSame($query, $uri->getQuery(), 'query');
        $this->assertSame($fragment, $uri->getFragment(), 'fragmnet');
        $this->assertSame($output, (string) $uri, 'toString');
    }
