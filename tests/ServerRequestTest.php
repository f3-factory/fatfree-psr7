...
class ServerRequestTest extends TestCase
{
    ...
    {
        $request1 = (new ServerRequest())->withMethod('GET')->withUri('/');
    ...
    public function testServerParams()
    {
        ...
        $request = (new ServerRequest())->withMethod('GET')->withUri( '/');
        $request->setServerParams($params);
    ...
    {
        $request = ((new ServerRequest())->withMethod('GET')->withUri( '/'))->withAttribute('name', null);
